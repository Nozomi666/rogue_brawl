...
--private
    ...
    destroy = function (self)
        ...
        self.button_map_show[self._id] = nil 
    ...
    show = function (self)
        ...
        self._panel:show()
        self.button_map_show[self._id] = self 
    end,
    ...
    set_cd = function (self,currentValue,maxValue)
        ...
        if currentValue ~= nil and currentValue > 0 then 
            ...
            self._cd_animation:set_normal_image('core\\black_icon.tga')
            ...
            game.loop(50,function (timer)
                ...
                if button._cd >= 0 then 
                    ...
                    texture:set_normal_image('empty.blp')
    ...
    set_enable_image = function (self,image_path,x,y,width,height)
        self._enable_param = {image_path or 'core\\black_icon.tga',x,y,width,height}
    end,
...
ac.loop(700,function ()
    for id, button in pairs(class.button.button_map) do
        if button:get_is_show() then
            class.button.button_map_show[id] = button
        else
            class.button.button_map_show[id] = nil
        end
    end
end)
